...
index = new_df[(new_df['overview']=='') & (new_df['overview'] == '')].index #Find indices of movies with blank overviews (plots) and genres
...
new_df.to_csv('input/processed_data.csv', index = False) #Save to CSV file
